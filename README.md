...
The demonstration itself activates the environment using [`pixi shell-hook`](https://pixi.prefix.dev/latest/reference/cli/pixi/shell-hook/) to avoid launching a new shell.
...
The remaining steps assume that they are performed from within the root of the repository.
...
The notebooks will be available in the `_notebooks` directory.
